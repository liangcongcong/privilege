...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>End Type Manage Page</title>
...
<body>
    ...
    $(document).ready(function () {
        ...
        grid = $('#grid').edatagrid({
			title: '递归终止符管理',
            method: 'post',
            url: '<%=basePath%>manage/endType/list',
            saveUrl: '<%=basePath%>manage/endType/add',
            updateUrl: '<%=basePath%>manage/endType/update',
            //只传id
            destroyUrl: '<%=basePath%>manage/endType/del',
			border : false,
			rownumbers : true,
			remoteSort : true,
			nowrap : false,
